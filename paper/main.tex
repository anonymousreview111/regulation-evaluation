...
requirement of the three frameworks. To our knowledge this is the first crosswalk spanning
all three simultaneously in the technical literature; we present it as a transparently coded
artifact---independently sampled by a second coder and recoded by an external reviewer---that
...
\input{tab_search.tex}
\input{tab_incl.tex}
\begin{figure}[!tbp]\centering\includegraphics[width=\columnwidth]{../figures/fig_prisma.pdf}
...
\input{sec_taxonomy.tex}

\section{Mapping Evaluation Methods to Regulatory Requirements}\label{sec:mapping}
\begin{figure*}[!tp]\centering\includegraphics[width=0.92\textwidth]{../figures/fig_heatmap.pdf}
...
\begin{figure*}[!tp]\centering\includegraphics[width=0.82\textwidth]{../figures/fig_crosswalk.pdf}
...
\input{sec_mapping.tex}

\section{Gap Analysis}\label{sec:gaps}
\begin{figure*}[!tp]\centering\includegraphics[width=0.92\textwidth]{../figures/fig_gap.pdf}
