...
relevance}---how far the method's output could contribute to an evidentiary case for the
...
while \textsc{Manage}---ongoing risk treatment and monitoring---is chiefly served by
...
character that technical methods only partly satisfy---hence those cells are coded
...
compatibility---that the same artifact can satisfy the evidentiary need of each clause---and
